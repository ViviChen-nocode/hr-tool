...
export default function FloatingMascot() {
  ...
  const handleClick = () => {
    window.open(
      'https://liff.line.me/1645278921-kWRPP32q/?accountId=026adbfw',
      '_blank',
    )
  }
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-white rounded-2xl px-4 py-2 shadow-lg border border-gray-200 whitespace-nowrap flex items-center gap-2">
          <LineIcon className="w-4 h-4 text-[#06C755]" />
          <p className="text-sm font-medium text-gray-700">聯繫大師姐</p>
        </div>
        {/* Bubble tail */}
